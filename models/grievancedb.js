...
mongoose.connect("mongodb+srv://RudhramSaraswat:Omjaisairam@1234@rudhramrudhram.oft9r.mongodb.net/?retryWrites=true&w=majority",{ useNewUrlParser: true,useCreateIndex: true,useUnifiedTopology:true,useFindAndModify:false }).then(() =>{
    console.log("done")
}).catch((err) =>{
    console.log("oops!")
});
